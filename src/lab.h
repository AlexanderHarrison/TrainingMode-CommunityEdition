...
const u8 LabValues_HitboxTrailDecayConst[] = { 15, 10, 0, 30, 0 };
const u8 LabValues_HitboxTrailDecayFactor[] = { 4, 8, 200, 2, 0 };
const char *LabOptions_HitboxTrailDecay[] = { "Normal", "Fast", "Instant", "Slow", "Off" };
