...
u32 rec_event_data_sizes[RecEvent_Count] = {
    0,
    sizeof(RecEvent_MatchInit),
    sizeof(RecEvent_Savestate_v1),
    sizeof(RecEvent_Savestate_v2),
    sizeof(RecEvent_RecordingSlot_v1),
    sizeof(RecEvent_RecordingSlot_v2),
    sizeof(RecEvent_MenuSettings_Record_v1),
    sizeof(RecEvent_MenuSettings_Record_v2),
    sizeof(RecEvent_MenuSettings_BehaviorOptions),
    sizeof(RecEvent_MenuSettings_DIOptions),
    sizeof(RecEvent_MenuSettings_TechOptions),
    sizeof(RecEvent_MenuSettings_InfoDisplay),
    sizeof(RecEvent_MenuSettings_ActionLog),
    sizeof(RecEvent_MenuSettings_CustomOSDs),
    sizeof(RecEvent_MenuSettings_Overlays),
    sizeof(RecEvent_MenuSettings_RNGControl),
};
